...
def defence(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'mage':
        mage_block = 10 + randint(-2, 2)
        return (f'{char_name} блокировал {mage_block} урона')
    if char_class == 'healer':
        healer_block = 10 + randint(2, 5)
        return (f'{char_name} блокировал {healer_block} урона')
    return (f'{char_name} не применил блокировку урона')
...
def special(char_name: str, char_class: str) -> str:
    if char_class == 'warrior':
        ...
        return (f'{char_name} применил специальное '
                f'умение «Выносливость {warrior_stamina}»')
    if char_class == 'mage':
        mage_attack = 5 + 40
        return (f'{char_name} применил специальное '
                f'умение «Атака {mage_attack}»')
    if char_class == 'healer':
        healer_protect = 10 + 30
        return (f'{char_name} применил специальное '
                f'умение «Защита {healer_protect}»')
